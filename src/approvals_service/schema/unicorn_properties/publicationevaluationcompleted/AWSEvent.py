...
from schema.unicorn_properties.publicationevaluationcompleted.PublicationEvaluationCompleted import PublicationEvaluationCompleted  # noqa: F401,E501
...
class AWSEvent(object):
    ...
    _types = {
        'account': 'str',
        'detail': 'PublicationEvaluationCompleted',
        'detail_type': 'str',
        'id': 'str',
        'region': 'str',
        'resources': 'list[str]',
